...
public class GroupLevelRepositoryPortTest {
    ...
    class CrudTest {
        ...
        void testSaveAndRetrieveGroupLevel() {
            ...
            TypedQuery<GroupLevel> query = entityManager.createQuery(
                    "SELECT gl FROM GroupLevel gl JOIN FETCH gl.group WHERE " +
                            "gl" +
                            ".groupName = :groupName AND gl.levelName = " +
                            ":levelName",
                    GroupLevel.class);
        ...
        void testFindAllGroupLevels() {
            ...
            List<GroupLevel> allGroupLevels =
                    groupLevelRepositoryPort.findAll();
        ...
        void testDeleteGroupLevel() {
            ...
            List<GroupLevel> allGroupLevelsBefore =
                    groupLevelRepositoryPort.findAll();
            ...
            List<GroupLevel> allGroupLevelsAfter =
                    groupLevelRepositoryPort.findAll();
    ...
    class ReferentialIntegrityTest {
        ...
        void testDeleteAndVerifyForeignKeyConstraint() {
            ...
            List<GroupLevel> remainingGroupLevels =
                    groupLevelRepositoryPort.findAll();
            assertEquals(1, remainingGroupLevels.size());
            assertEquals("basic admin",
                    remainingGroupLevels.getFirst().getLevelName());
        ...
        void testDeleteGroupCascadesToGroupLevels() {
            ...
            Query nativeQuery = entityManager.createNativeQuery(
                    "SELECT COUNT(*) FROM group_levels WHERE group_name = " +
                            ":groupName");
            ...
            assertEquals(1, allGroupLevelsAfter.size());
            assertEquals("admin",
                    allGroupLevelsAfter.getFirst().getGroupName());
        }
        ...
        void testIntegrityConstraint_GroupMustExist() {
            ...
            Group nonExistentGroup =
                    Group.builder().groupName("nonexistent").build();
    ...
    class CustomMethodsTest {
        ...
        void testFindByGroupName() {
            ...
            List<GroupLevel> foundLevels =
                    groupLevelRepositoryPort.findByGroupName("multiLevel");
        ...
        void testFindByGroupNameWithNoLevels() {
            ...
            List<GroupLevel> foundLevels =
                    groupLevelRepositoryPort.findByGroupName("emptyGroup");
    ...
    class ConcurrencyTest {
        ...
        void testOptimisticLocking() {
            ...
            GroupLevel groupLevel = GroupLevel.builder()
                    ...
                    .levelName("entry")
                    .build();
            groupLevelRepositoryPort.saveAndFlush(groupLevel); // Salvo il livello per ottenere una versione iniziale
            ...
            assertThrows(ObjectOptimisticLockingFailureException.class, () -> {
                groupLevelRepositoryPort.saveAndFlush(g2); // Fallisce: versione non aggiornata
            });
        }
    }
