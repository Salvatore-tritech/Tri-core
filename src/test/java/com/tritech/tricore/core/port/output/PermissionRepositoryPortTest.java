...
public class PermissionRepositoryPortTest {
    ...
    class CrudTest {
        ...
        void testSaveAndRetrievePermission() {
            ...
            Permission fetchedPermission =
                    permissionRepositoryPort.findById(id).orElseThrow();
        ...
        void testFindAllPermissions() {
            ...
            GroupLevel level1 =
                    GroupLevel.builder().groupName("teamA").levelName("level1"
                    ).build();
            GroupLevel level2 =
                    GroupLevel.builder().groupName("teamA").levelName("level2"
                    ).build();
            ...
            permissionRepositoryPort.save(Permission.builder().subject(123456L).groupName("teamA").levelName("level1").build());
            permissionRepositoryPort.save(Permission.builder().subject(123456L).groupName("teamA").levelName("level2").build());

            // Recupero tutte le Permissions
            List<Permission> allPermissions =
                    permissionRepositoryPort.findAll();
        ...
        void testDeletePermission() {
            ...
            GroupLevel level =
                    GroupLevel.builder().groupName("teamB").levelName("admin").build();
            ...
            Permission permission =
                    Permission.builder().subject(123456L).groupName("teamB").levelName("admin").build();
            permissionRepositoryPort.save(permission);
    ...
    class ReferentialIntegrityTest {
        ...
        void testDeleteGroupLevelCascadesToPermission() {
            ...
            GroupLevel groupLevel =
                    GroupLevel.builder().groupName("groupA").levelName(
                            "level1").build();
            groupLevelRepositoryPort.save(groupLevel);
            ...
            permissionRepositoryPort.save(Permission.builder().subject(123456L).groupName("groupA").levelName("level1").build());
    ...
    class ConcurrencyTest {
        ...
        void testOptimisticLocking() {
            ...
            GroupLevel groupLevel =
                    GroupLevel.builder().groupName("groupX").levelName("admin"
                    ).build();
            groupLevelRepositoryPort.save(groupLevel);
            ...
            Permission p1 = entityManager.find(Permission.class,
                    new PermissionId(123456L, "groupX", "admin"));
            entityManager.detach(p1);

            Permission p2 = entityManager.find(Permission.class,
                    new PermissionId(123456L, "groupX", "admin"));
    ...
    class AuditTest {
        ...
        void testAuditFieldsAreSet() {
            ...
            GroupLevel groupLevel =
                    GroupLevel.builder().groupName("groupY").levelName("audit"
                    ).build();
            groupLevelRepositoryPort.save(groupLevel);
