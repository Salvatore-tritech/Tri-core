 ...
 * <p>
 * This class is used to identify a `Permission` uniquely through a combination of the
 * following fields:
 * <ul>
 * <li>`subject`: The unique identifier of the user associated with the permission.</li>
