...
/**
 * <p>
 * Represents a user entity within the system. This class is mapped to the "users" table
 * in the database.
 * </p>
 * <p>
...
public class User {
	...
	/**
	 * Represents the unique identifier for a user within the system. This field is mapped
	 * to the "subject" column in the "users" table and serves as the primary key for the
	 * User entity.
	 * <p>
	...
	/**
	 * Represents the full name of a user within the system. This field is mapped to the
	 * "fullname" column in the "users" table and is a required attribute, as specified by
	...
	/**
	 * Represents the email address associated with a user in the system. This field is
	 * mapped to the "email" column in the database and is a required attribute.
	 */
	@Column(name = "email", nullable = false)
	private String email;

	/**
	 * Represents the profile picture associated with a user within the system. This field
	 * is mapped to the "picture" column in the "users" table in the database.
	 * <p>
