 ...
 * </p>
 * <ul>
 * <li>Database versioning using an optimistic locking strategy through the
 * {@code version} field.</li>
 ...
 * </ul>
 * <p>
 * The {@code Group} entity is referenced by other entities, such as {@link GroupLevel},
 * to establish associations within the domain model.
 * </p>
 */
@Entity
@Table(name = "groups")
